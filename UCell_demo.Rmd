...
DimPlot(object = pbmc.Tcell.ss, reduction = "umap", group.by = "celltype.l2", label.size = 3, repel = TRUE, label = T)
DimPlot(object = pbmc.Tcell.ss, reduction = "umap", split.by = "celltype.l2", label.size = 3, repel = TRUE, ncol=4)
FeaturePlot(pbmc.Tcell.ss, features = sign.names, ncol=3, order=T)
```
