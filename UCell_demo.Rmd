...
```
How to handle missing genes ("impute" vs "skip")
```{r}
sig <- list(Tcell_CD8=c("CD8A","CD8B"))
r1 <- AddModuleScore_UCell(pbmc.Tcell.CD8, features = sig)

sig <- list(Tcell_CD8=c("CD8A","CD8B","notagene"))
r2 <- AddModuleScore_UCell(pbmc.Tcell.CD8, features = sig, missing_genes = "skip")

sig <- list(Tcell_CD8=c("CD8A","CD8B","notagene"))
r3 <- AddModuleScore_UCell(pbmc.Tcell.CD8, features = sig, missing_genes = "impute")

head(cbind(r1$Tcell_CD8_UCell, r2$Tcell_CD8_UCell, r3$Tcell_CD8_UCell), 20)
