...
sce <- ScoreSignatures_UCell_sce(sce, features=signatures, assay = 'counts', name=NULL, ncores=4)
altExp(sce, 'UCell')
```
...
To see how UCell can interact directly with Seurat to analyse human PBMCs see [THIS VIGNETTE](https://carmonalab.github.io/UCell/UCell_Seurat_vignette.html)
